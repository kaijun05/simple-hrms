...
if (isset($_GET['id'])) {
    ...
    if ($employee = mysqli_fetch_assoc($result)) {
        // Convert date_of_birth to string format (MySQL DATE format)
...
<head>
    ...
    <link rel="stylesheet" href="../styles/hr_view.css">
</head>
<body>
    <div class="container">
        ...
        <form>
            ...
            <div class="button-container">
                ...
                <a href="../src/hr_update.php?id=<?= $employee_id ?>" class="update-button">Update Info</a>
            </div>
        </form>
    </div>
